...
import lab7.main.java.exception.SavingFileException;
...
public class CollectionManager {
    ...
    public void saveToFile() throws SavingFileException {
        ...
        try (PrintWriter writer = new PrintWriter(filePath)) {
            ...
            throw new SavingFileException("Error saving collection to file: " + e.getMessage());
        }
    }
}